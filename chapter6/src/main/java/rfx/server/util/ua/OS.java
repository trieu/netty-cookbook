...
public class OS {	
	...
	public static OS fromMap(Map<String, String> m) {
		return new OS(m.get("family"), m.get("major"), m.get("minor"),
				m.get("patch"), m.get("patch_minor"));
	}
	...
	public boolean equals(Object other) {
		...
		return ((this.family != null && this.family.equals(o.family)) || this.family == o.family)
				...
				&& ((this.patchMinor != null && this.patchMinor
						.equals(o.patchMinor)) || this.patchMinor == o.patchMinor);
	}
	...
	public String toString() {
		return String
				.format("{family: %s, major: %s, minor: %s, patch: %s, patch_minor: %s}",
